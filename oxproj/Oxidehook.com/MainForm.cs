	...
	public partial class MainForm : Form
	{
		...
		private void Inject()
		{
			...
			if (true) //module.ID > 0
			{
				...
				if (Loader.PHInject(ref injectRequest, 2))
				{
		...
		{
			MessageBox.Show("Inject clicked!");
			Process[] processesByName = Process.GetProcessesByName("csgo");
		...
		{
			ModuleListbox.Items.Add("CS:GO Beta");
			ModuleListbox.Items.Add("CS:GO Oxide");
			ModuleListbox.Items.Add("Ver3");
			this.BackColor = Color.LavenderBlush;
			base.TransparencyKey = Color.LavenderBlush;
		...
		private void Main_Load(object sender, EventArgs e)
		{
			...
			welcomeLabel.Text += "GG"; //Loader.PHGetUsername()
		}
